#ifndef MODELEPLATEAU_H
#define MODELEPLATEAU_H
...
{
public:
    ModelePlateau(const uint8_t& colonnes, const uint8_t& lignes);

    virtual ~ModelePlateau();
    ...
    */
    uint8_t GetColor(const uint8_t& column, const uint8_t& row);
